	...
	<div class="<?php if ( $nectar_fp_options['page_full_screen_rows'] !== 'on' ) { echo 'container'; } ?> main-content">
		<div class="row">
				...
				<div class="mycolm">
					<label for="textSearcher" ><strong>Filter by Make</strong>
						<select id="textSearcher">
							...
							<option value="Scripps-Booth">Scripps-Booth</option>
					...
					<label for="textSearcher"><strong>Filter by Day or Collection</strong>
						<select id="collection" >
							<option value="">Filter by Day or Collection</option>
							<option value="Selling on Saturday">Saturday Lots</option>
							<option value="Selling on Friday">Friday Lots</option>
							<option value="Selling on Thursday">Thursday Lots</option>
							<option value="The Rockhound Collection">The Rockhound Collection</option>
							<option value="The Tom Sharp Collection">The Tom Sharp Collection</option>
						</select>
					</label>
				</div>
				<script>
			...
			<div class="row">
				...
				<div id="mainArea">
					<h3 style="font-weight: bold; text-align: center;">Full Inventories</h3>
					<?php
